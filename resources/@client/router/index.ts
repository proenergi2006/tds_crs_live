...

    {
        ...
        children: [
            ...
            },
            {
                ...
                name: "produk-hargas",
                component: () =>
                    import("@/pages/MasterData/HargaProduk/Index.vue"),
                // meta: { roles: [2, 5] },
            },
            {
                ...
                component: () =>
                    import("@/pages/MasterData/HargaProduk/Detail.vue"),
                meta: { breadcrumbTitle: "Detail Harga Produk" },
            },
            {
                path: "produk-hargas/create",
                name: "produk-hargas-create",
                component: () =>
                    import("@/pages/MasterData/HargaProduk/Form.vue"),
                meta: {
                    roles: [2, 5, 8],
            ...
            },
            {
                ...
                component: () =>
                    import("@/pages/AttachmentHargaDasarCreate.vue"),
                meta: { roles: [2, 5, 8] },
            },
            {
            ...
            },
            {
                ...
                name: "terminals-list",
                component: () =>
                    import("@/pages/MasterData/Terminal/Index.vue"),
                meta: { roles: [5] },
            },

            {
                ...
                component: () =>
                    import("@/pages/Transactions/PoSupplier/Index.vue"),
                meta: { roles: [5] },
            },
            {
                ...
                component: () =>
                    import("@/pages/Transactions/PoSupplier/Form.vue"),
                meta: { roles: [5] },
            },
            {
            ...
            },
            {
                ...
                component: () =>
                    import("@/pages/Transactions/PoSupplier/Detail.vue"),
                meta: { roles: [5] },
            },
            {
                ...
                component: () =>
                    import("@/pages/Transactions/PoSupplier/Receive.vue"),
                meta: { roles: [5] },
            },

            {
                ...
                component: () =>
                    import("@/pages/Transactions/GoodReceipt/Index.vue"),
                meta: { roles: [5] },
            },
            ...
            },
            {
                ...
                component: () =>
                    import("@/pages/PenawaranVerifikasiListProenergi.vue"),
            },
            {
            ...
            },
            {
                ...
                component: () =>
                    import("@/pages/VerifikasiDetailProenergi.vue"), // Pastikan path sesuai
            },
            {
                path: "/penawarans/verifikasi/om",
                name: "penawarans-verifikasi-om",
                component: () =>
                    import("@/pages/PenawaranVerifikasiListOm.vue"),
            },
            {
            ...
            },
            {
                ...
                component: () =>
                    import("@/pages/VerifikasiOmDetailProenergi.vue"),
            },
            {
            ...
            },
            {
                ...
                component: () =>
                    import("@/pages/ReviewDataCustomerLogistik.vue"),
            },
            {
            ...
            },
            {
                ...
                component: () =>
                    import("@/pages/SalesConfirmationBMDetail.vue"),
            },

            {
                ...
                component: () =>
                    import("@/pages/SalesConfirmationBMDetailClassic.vue"),
                props: true,
            },
