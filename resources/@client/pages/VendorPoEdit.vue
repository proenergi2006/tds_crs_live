<template>
  <div v-if="initialized" class="p-4">
          ...
          <CardSection title="Catatan & Terms" description="Informasi tambahan untuk purchase order" icon="StickyNote"
            ...
            <div class="space-y-4">
              ...
              <div>
                ...
                <FormTextarea id="terms_condition" v-model="form.terms_condition" rows="6" placeholder="(opsional)" />
              </div>
            </div>
          </CardSection>
  ...
  <div v-else class="p-4">
    <div class="rounded-2xl bg-white p-10 text-center text-slate-500 shadow-sm">
