  ...
  <div class="p-4">
    ...
    <div
      ...
      <div class="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <div
            class="mb-2 inline-flex items-center rounded-full bg-white/15 px-3 py-1 text-xs font-medium backdrop-blur-sm">
        ...
        <table class="min-w-full divide-y divide-slate-200">
          <thead class="bg-slate-50">
            <tr>
              ...
              <th class="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-slate-600">Volume PO
              </th>
              <th class="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-slate-600">Harga
                Tebus</th>
              <th class="px-4 py-3 text-right text-xs font-semibold uppercase tracking-wide text-slate-600">Jumlah
                Harga</th>
            </tr>
          </thead>

          <tbody class="divide-y divide-slate-200">
            <tr v-for="item in po.produks" :key="item.id_po_produk" class="transition-colors hover:bg-slate-50">
              <td class="px-4 py-4">
    ...
    <div class="mt-6 flex flex-wrap justify-end gap-3">
      ...
      <Button v-if="po.disposisi_po === 0" variant="primary" :loading="loading" @click="approve">
