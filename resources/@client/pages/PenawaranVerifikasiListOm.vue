      ...
      <div class="mb-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
            <FormInput v-model="searchQuery" placeholder="Cari nomor atau customer…" class="w-full sm:w-80 pr-10 !box">
              <template #icon>
        ...
        <div class="overflow-x-auto">
          <Table class="min-w-full">
            ...
            <Table.Tbody>
              ...
              <!-- Data -->
              <Table.Tr v-for="(pen, idx) in penawarans" v-else :key="pen.id_penawaran"
                ...
                <Table.Td class="text-center">
                  <RouterLink :to="{ name: 'penawarans-verifikasi-om-detail', params: { id: pen.id_penawaran } }"
