...
<template>
  <div class="grid grid-cols-12 gap-6">
    <div class="col-span-12 mt-4 intro-y">
      ...
      <DataList :loading="loading" :empty="ukurans.length === 0" :colspan="4" loading-text="Memuat data ukuran..."
        ...
        <template #body>
          <Table.Tr v-for="(u, idx) in ukurans" :key="u.id_ukuran" class="hover:bg-slate-100 transition-colors">
        ...
        <Dialog.Panel class="w-96 p-6">
          ...
          <div class="space-y-3">
            ...
            <div>
              ...
              <FormInput id="create-nama" v-model="createForm.nama_ukuran" placeholder="Nama Ukuran"
                :class="createFieldErr.nama_ukuran ? 'border-rose-500' : ''" required />
            ...
            <div>
              ...
              <FormSelect id="create-satuan" v-model="createForm.id_satuan"
                :class="createFieldErr.id_satuan ? 'border-rose-500' : ''" required>
        ...
        <Dialog.Panel class="w-96 p-6">
          ...
          <div class="space-y-3">
            ...
            <div>
              ...
              <FormInput id="edit-nama" v-model="editForm.nama_ukuran" placeholder="Nama Ukuran"
                :class="editFieldErr.nama_ukuran ? 'border-rose-500' : ''" required />
            ...
            <div>
              ...
              <FormSelect id="edit-satuan" v-model="editForm.id_satuan"
                :class="editFieldErr.id_satuan ? 'border-rose-500' : ''" required>
                <option disabled value="">-- Pilih Satuan --</option>
                <option v-for="s in satuans" :key="s.id_satuan" :value="s.id_satuan">
                  {{ s.nama_satuan }}
                </option>
