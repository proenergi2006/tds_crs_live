...
function openCreate() {
  router.push({ name: 'customers-create-proenergi' })
}

function openEdit(id: number) {
  router.push({ name: 'customers-edit-proenergi', params: { id } })
}
...
<template>
  <div class="page-content-wrapper">
    <div class="intro-y flex flex-col gap-4">
      <PageHeader
        title="Master Customers Proenergi"
        description="Kelola data customer Proenergi yang kamu tangani"
      >
        <template #action>
