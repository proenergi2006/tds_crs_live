...
const displayPriceListPe = ref('0')
...
function onPriceListPeInput(e: Event) {
  if (isReadonly('harga_price_list_pe')) return
  const raw = parseMoney(e)
  const n = raw ? parseInt(raw, 10) : 0
  form.harga_price_list_pe = n
  displayPriceListPe.value = formatID(n)
}
...
async function submit() {
  ...
  try {
    const payload = {
      ...
      harga_price_list_pe: isReadonly('harga_price_list_pe') ? 0 : toIntMoney(form.harga_price_list_pe),
      harga_bm: isReadonly('harga_bm') ? 0 : toIntMoney(form.harga_bm),
      harga_cogs: toIntMoney(form.harga_cogs),
...
onMounted(async () => {
  ...
  form.harga_price_list_pe = toIntMoney(data.harga_price_list_pe)
  ...
  displayPriceListPe.value = formatID(form.harga_price_list_pe)
      ...
      <div class="col-span-12">
        <div class="p-6 box">
          ...
          <div class="space-y-4">
            ...
            <div>
              <FormLabel>Harga Price List PE</FormLabel>
              <FormInput
                type="text"
                v-model="displayPriceListPe"
                @input="onPriceListPeInput"
                class="text-right"
                placeholder="0"
