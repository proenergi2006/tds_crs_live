...
<template>
    <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 mt-4 intro-y">
            ...
            <DataList :loading="loading" :empty="jenisProduks.length === 0" :colspan="5"
                loading-text="Memuat jenis produk..." empty-description="Belum ada data jenis produk.">
                <template #head>
                ...
                <template #body>
                    <Table.Tr v-for="(p, idx) in jenisProduks" :key="p.id_jenis"
                        ...
                        <Table.Td class="text-center">
                            <button type="button" @click.prevent="openEdit(p)"
                            ...
                            <button type="button" @click="confirmDelete(p.id_jenis)"
                ...
                <Dialog.Panel class="w-96 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <FormInput id="create-deskripsi" v-model="createForm.deskripsi"
                    ...
                    <div class="flex justify-end space-x-2 mt-4">
                        <Button variant="outline-secondary" @click="createModal = false"
                ...
                <Dialog.Panel class="w-96 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <FormInput id="edit-deskripsi" v-model="editForm.deskripsi"
                                placeholder="Deskripsi (opsional)" />
                        </div>
                    ...
                    <div class="flex justify-end space-x-2 mt-4">
                        <Button variant="outline-secondary" @click="editModal = false"
                            class="inline-flex items-center gap-2">
                            <Lucide icon="X" class="w-4 h-4" />
                            <span>Cancel</span>
                        </Button>
                ...
                <Dialog.Panel class="p-5 text-center">
                    ...
                    <div class="px-5 pb-8 text-center mt-4">
                        <Button variant="outline-secondary"
                            class="w-28 mr-2 inline-flex items-center justify-center gap-2"
                            @click="deleteModal = false">
                            <Lucide icon="X" class="w-4 h-4" />
                            <span>Batal</span>
                        </Button>
                        <Button variant="danger" ref="deleteButtonRef"
                            class="w-28 inline-flex items-center justify-center gap-2" @click="submitDelete">
