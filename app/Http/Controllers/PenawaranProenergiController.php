...
use App\Models\PenawaranOngkosProenergi;
...
private function saveQrSvgToStorage(string|array $payload, int $idPenawaran): array
{
   ...
   public function previewPdf($id)
   {
    ...
    // {
    //     $penawaran = PenawaranProenergi::with(['customer', 'cabang', 'items.produk.ukuran'])
    //         ->findOrFail($id);
    ...
    public function verifikasi(Request $request, $id)
{
    ...
    private function detailUrl(int $idPenawaran): string
    {
        ...
        return url("/app/penawarans-proenergi/{$idPenawaran}/detail");
    }
    ...
    public function previewPdfMultiLang(Request $request, $id)
    {
        ...
        $logoLeftPath  = public_path('images/logo-proenergi.png');
