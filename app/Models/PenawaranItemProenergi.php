...
class PenawaranItemProenergi extends Model
{
    protected $table      = 'penawaran_items_proenergi';
    ...
    {
        return $this->belongsTo(PenawaranProenergi::class, 'id_penawaran', 'id_penawaran');
    }
